...
base_folder = r"C:\CbakerDesktop\MegaCRN\save"
os.makedirs(base_folder, exist_ok=True)
path = os.path.join(base_folder, f"{args.dataset}_{model_name}_{timestring}")
os.makedirs(path, exist_ok=True)  # create the nested output folder
